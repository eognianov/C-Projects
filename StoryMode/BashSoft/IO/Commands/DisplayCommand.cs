...
namespace BashSoft.IO.Commands
{
    ...
    {
        public DisplayCommand(string input, string[] data, IConterComparer judge, IDatabase repository, IDirectoryManager inputOutputManager) : base(input, data, judge, repository, inputOutputManager)
        {
        }
